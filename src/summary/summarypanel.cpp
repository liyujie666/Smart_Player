...
void SummaryPanel::buildUI() {
    ...
    setStyleSheet(QString::fromLatin1(R"(
        ...
        SummaryPanel QScrollBar::handle:vertical:hover {
            background: #9CA3AF;
        }
        SummaryPanel QScrollBar::handle:vertical:pressed {
            background: #6B7280;
        }
        ...
        SummaryPanel QScrollBar::handle:horizontal:hover {
            background: #9CA3AF;
        }
        SummaryPanel QScrollBar::handle:horizontal:pressed {
            background: #6B7280;
        }
