...
public:
    ...
    QPushButton *aiSummaryBtn;
    QSpacerItem *horizontalSpacer;
    QPushButton *switchPlayModeBtn;
...
"}"));
        ...
        playerPage->setStyleSheet(QString::fromUtf8(""));
...
"}"));
        ...
        infoLabel->setMinimumSize(QSize(0, 49));
        infoLabel->setMaximumSize(QSize(624, 49));
...
"    }\n"
"\n"
"/* ========== \346\232\227\350\211\262\346\273\232\345\212\250\346\235\241\357\274\210\344\273\205\344\275\234\347\224\250\344\272\216 fileList \345\206\205\347\232\204\346\273\232\345\212\250\346\235\241\357\274\211 ========== */\n"
"\n"
"/* \345\236\202\347\233\264\346\273\232\345\212\250\346\235\241 */\n"
"QListWidget#fileList QScrollBar:vertical {\n"
"    background: transparent;             /* \346\225\264\346\235\241\346\273\232\345\212\250\346\235\241\350\203\214\346\231\257\351\200\217\346\230\216 */\n"
"    width: 8px;                          /* \346\273\232\345\212\250\346\235\241\345\256\275\345\272\246 */\n"
"    margin: 4px 2px 4px 0;               /* \344\270\212\344\270"
                        "\213\347\225\231\345\207\272 4px \350\256\251\346\273\221\345\235\227\344\270\215\344\274\232\350\264\264\350\276\271 */\n"
"    border: none;\n"
"}\n"
"QListWidget#fileList QScrollBar::handle:vertical {\n"
"    background: rgba(255, 255, 255, 0.18); /* \345\215\212\351\200\217\346\230\216\347\231\275,\345\217\240\345\212\240\345\234\250\351\273\221\345\272\225\344\270\212\345\221\210\346\267\261\347\201\260 */\n"
"    min-height: 40px;                    /* \346\273\221\345\235\227\346\234\200\345\260\217\351\253\230\345\272\246,\351\201\277\345\205\215\345\244\252\347\237\255\347\234\213\344\270\215\350\247\201 */\n"
"    border-radius: 4px;                  /* \345\234\206\350\247\222 */\n"
"    border: none;\n"
"}\n"
"QListWidget#fileList QScrollBar::handle:vertical:hover {\n"
"    background: rgba(255, 255, 255, 0.32); /* hover \345\217\230\344\272\256 */\n"
"}\n"
"QListWidget#fileList QScrollBar::handle:vertical:pressed {\n"
"    background: rgba(255, 255, 255, 0.45); /* \346\214\211\344\270\213\346\227\266"
                        "\346\233\264\344\272\256 */\n"
"}\n"
"QListWidget#fileList QScrollBar::add-line:vertical,\n"
"QListWidget#fileList QScrollBar::sub-line:vertical {\n"
"    background: none;                    /* \351\232\220\350\227\217\344\270\212\344\270\213\347\256\255\345\244\264\346\214\211\351\222\256 */\n"
"    border: none;\n"
"    height: 0px;\n"
"}\n"
"QListWidget#fileList QScrollBar::add-page:vertical,\n"
"QListWidget#fileList QScrollBar::sub-page:vertical {\n"
"    background: none;                    /* \346\273\221\346\247\275\346\234\252\350\242\253\350\246\206\347\233\226\351\203\250\345\210\206\351\200\217\346\230\216 */\n"
"    border: none;\n"
"}\n"
"\n"
"/* \346\260\264\345\271\263\346\273\232\345\212\250\346\235\241\357\274\210\344\277\235\347\225\231\346\227\247\351\243\216\346\240\274,\351\241\272\346\211\213\346\224\271\346\210\220\346\232\227\350\211\262\357\274\211*/\n"
"QListWidget#fileList QScrollBar:horizontal {\n"
"    background: transparent;\n"
"    height: 8px;\n"
...
""
                        "    border: none;\n"
"}\n"
"QListWidget#fileList QScrollBar::handle:horizontal {\n"
"    background: rgba(255, 255, 255, 0.18);\n"
"    min-width: 40px;\n"
"    border-radius: 4px;\n"
"    border: none;\n"
"}\n"
"QListWidget#fileList QScrollBar::handle:horizontal:hover {\n"
"    background: rgba(255, 255, 255, 0.32);\n"
"}\n"
"QListWidget#fileList QScrollBar::handle:horizontal:pressed {\n"
"    background: rgba(255, 255, 255, 0.45);\n"
"}\n"
"QListWidget#fileList QScrollBar::add-line:horizontal,\n"
"QListWidget#fileList QScrollBar::sub-line:horizontal {\n"
"    background: none;                    /* \351\232\220\350\227\217\345\267\246\345\217\263\347\256\255\345\244\264 */\n"
"    border: none;\n"
"    width: 0px;\n"
"}\n"
"QListWidget#fileList QScrollBar::add-page:horizontal,\n"
"QListWidget#fileList QScrollBar::sub-page:horizontal {\n"
"    background: none;                    /* \346\273\221\346\247\275\346\234\252\350\242\253\350\246\206\347\233\226\351\203\250\345\210\206\351\200\217\346\230\216 */\n"
""
                        "    border: none;\n"
"}"));
        ...
        controlBarContainer->setStyleSheet(QString::fromUtf8(""));
...
""));
        ...
        aiSummaryBtn = new QPushButton(controlBarContainer);
        aiSummaryBtn->setObjectName("aiSummaryBtn");
        aiSummaryBtn->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        aiSummaryBtn->setStyleSheet(QString::fromUtf8("QPushButton{\n"
"	max-height:35px;\n"
"	max-width:35px;\n"
"	min-height:35px;\n"
"	min-width:35px;\n"
...
""));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/SmartPlayer-icon/ai_summay_2.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        aiSummaryBtn->setIcon(icon8);
        aiSummaryBtn->setIconSize(QSize(28, 28));

        controlButtonBar->addWidget(aiSummaryBtn);
        ...
        switchPlayModeBtn = new QPushButton(controlBarContainer);
        switchPlayModeBtn->setObjectName("switchPlayModeBtn");
        switchPlayModeBtn->setStyleSheet(QString::fromUtf8("QPushButton{\n"
"	max-height:35px;\n"
"	max-width:35px;\n"
"	min-height:35px;\n"
"	min-width:35px;\n"
...
"}"));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/SmartPlayer-icon/list_circle.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        switchPlayModeBtn->setIcon(icon9);
        switchPlayModeBtn->setIconSize(QSize(26, 26));

        controlButtonBar->addWidget(switchPlayModeBtn);
...
"}"));
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/SmartPlayer-icon/last_video.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        preVideoBtn->setIcon(icon10);
...
"}"));
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/SmartPlayer-icon/back.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        back3sBtn->setIcon(icon11);
...
"}"));
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/SmartPlayer-icon/start.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        startBtn->setIcon(icon12);
...
"}"));
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/SmartPlayer-icon/forward.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        forward3sBtn->setIcon(icon13);
...
"}"));
        QIcon icon14;
        icon14.addFile(QString::fromUtf8(":/SmartPlayer-icon/next_video.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        nextVideoBtn->setIcon(icon14);
...
""));
        QIcon icon15;
        icon15.addFile(QString::fromUtf8(":/SmartPlayer-icon/stop.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        stopBtn->setIcon(icon15);
...
"}"));
        ...
        subtitleBtn = new QPushButton(controlBarContainer);
        subtitleBtn->setObjectName("subtitleBtn");
        subtitleBtn->setStyleSheet(QString::fromUtf8("QPushButton{\n"
"	max-height:35px;\n"
"	max-width:35px;\n"
"	min-height:35px;\n"
"	min-width:35px;\n"
...
"}"));
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/SmartPlayer-icon/ai_subtitles_2.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        subtitleBtn->setIcon(icon16);
        subtitleBtn->setIconSize(QSize(26, 26));

        controlButtonBar->addWidget(subtitleBtn);
...
"}"));
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/SmartPlayer-icon/volume.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        volumeBtn->setIcon(icon17);
...
"}"));
        QIcon icon18;
        icon18.addFile(QString::fromUtf8(":/SmartPlayer-icon/take_shot.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        screenShotBtn->setIcon(icon18);
...
"}"));
        QIcon icon19;
        icon19.addFile(QString::fromUtf8(":/SmartPlayer-icon/full_screen.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        fullScreenBtn->setIcon(icon19);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        aiSummaryBtn->setStatusTip(QCoreApplication::translate("MainWindow", "AI\346\200\273\347\273\223", nullptr));
#endif // QT_CONFIG(statustip)
        aiSummaryBtn->setText(QString());
        switchPlayModeBtn->setText(QString());
#if QT_CONFIG(tooltip)
